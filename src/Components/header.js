...
<a href="#" className="find-friends">Find Friends</a>
  ...
  <div className="box-content">
    <div className="dropdown-menu">
      ...
      FRIEND REQUESTS
        ...
        <a className="menu-text" href="#">SETTINGS</a>
        <a className="menu-text" href="#">FIND FRIENDS</a>
      </div>
    <div className="check-all-fr">
  ...
  <div className="box-content">
   <div className="dropdown-menu">
      ...
      CHAT/MESSAGES
        ...
        <a className="menu-text" href="#">SETTINGS</a>
        <a className="menu-text" href="#">MARK ALL AS READ</a>
      </div>
    <div className="check-all-m">
      See all messages
    </div>
  </div>
</div>
...
<div className="profile-box">
  ...
  <div className="content">  
    <div className="title-menu">
      ...
      <p><a className="account" href="#">Profile Settings</a> </p>
      <p><a className="account" href="#">Create Favourite Page</a> </p>
      <p><a className="account" href="#">Log Out</a>   </p>
    ...
    <p><a className="account" href="#">Terms and Conditions</a></p>
    <p><a className="account" href="#">FAQs</a> </p>
    <p><a className="account" href="#">Careers</a></p>
    <p><a className="account" href="#">Contact</a></p>     
